...
public class StateAgent : Agent
{
    ...
    void Start()
    {
		...
		stateMachine.AddTransition(nameof(ChaseState), new Transition(new Condition[] { enemySeenCondition, healthOkCondition, enemyNear }), nameof(AttackState));

		stateMachine.AddTransition(nameof(WanderState), new Transition(new Condition[] { timerExpiredCondition, enemyNotSeenCondition }), nameof(IdleState));
		...
		stateMachine.AddTransition(nameof(WanderState), new Transition(new Condition[] { enemyNear, enemySeenCondition }), nameof(AttackState));

		stateMachine.AddTransition(nameof(AttackState), new Transition(new Condition[] { animationDoneCondition }), nameof(ChaseState));

		stateMachine.AddTransition(nameof(EvadeState), new Transition(new Condition[] { enemySeenCondition, healthLowCondition }), nameof(IdleState));
